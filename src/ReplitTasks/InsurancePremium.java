...
public class InsurancePremium {
    ...
    public static void main(String[] args) {
        ...
        String drivingLicence = input.nextLine();
        double premiumCost = 0;

        while (drivingLicence.equalsIgnoreCase("yes")) {
            ...
            String ownedFinancedLeased = input.nextLine();
            if (ownedFinancedLeased.equalsIgnoreCase("owned")) {
                premiumCost += 10;
            } else if (ownedFinancedLeased.equalsIgnoreCase("financed")) {
                premiumCost += 15;
            } else if (ownedFinancedLeased.equalsIgnoreCase("leased")) {
                premiumCost += 10;
            }
            System.out.println("How is this vehicle primarily used?");
            String primarilyUsed = input.nextLine();
            if (primarilyUsed.equalsIgnoreCase("business")) {
                premiumCost += 50;
            } else if (primarilyUsed.equalsIgnoreCase("pleasure")) {
                premiumCost += 10;
            } else if (primarilyUsed.equalsIgnoreCase("commuting")) {
                premiumCost += 20;
            }
        }
